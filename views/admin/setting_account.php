          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                <h5 class="card-title">Rule for employees</h5>
                <p class="small fst-italic">Chấp hành các quy định và chính sách,bảo mật thông tin,đi làm đúng giờ ,đạo đức nghề nghiệp,tôn trọng đồng nghiệp và cấp trên,tránh xung đột, trách nhiệm và quản lý ,báo cáo công việc và tiến độ một cách đầy đủ và kịp thời cho cấp trên hoặc các bên liên quan.</p>
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <!-- Profile Edit Form -->
                <form action="?act=setting_account_update" method="post" id="profileForm" enctype="multipart/form-data">
                  <div class="row mb-3">
                    <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                    <div class="col-md-8 col-lg-9">
                      <img src="layout/images/avatas/<?=$user['avatar']?>" alt="Profile" id="previewImage">
                      <input type="file" name="profileImage" class="an" id="profileImage">
                      <div class="pt-2">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="company" type="text" disabled class="form-control" id="company" value="Thể Thao Store">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="job" type="text" disabled class="form-control" id="Job" value="Nhân viên quản trị">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="country" type="text" disabled class="form-control" id="Country" value="Việt Nam">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="twitter" type="text" disabled class="form-control" id="Twitter" value="https://twitter.com/#">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="facebook" type="text" disabled class="form-control" id="Facebook" value="https://facebook.com/#">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="instagram" type="text" disabled class="form-control" id="Instagram" value="https://instagram.com/#">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="linkedin" type="text" disabled class="form-control" id="Linkedin" value="https://linkedin.com/#">
                    </div>
                  </div>
